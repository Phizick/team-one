/**
 * @component
 * Компонент содержащий данные о пользователе и ссылки на получение рекомендации
 * Отправляет dispatch на открытие модального окна с информацией о пользователе
 * @props
 * isActive - принимает true || false, если true - ссылка-кнопка отображается, false - нет
 * @returns
 * возвращает разметку блока Header
 */
